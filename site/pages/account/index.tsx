        ...
        <div className="grid items-center max-w-2xl grid-cols-1 px-4 py-8 mx-auto gap-y-16 gap-x-8 sm:px-6 sm:py-16 lg:max-w-7xl lg:px-8 lg:grid-cols-1">
          <div className="">
            ...
            <div className="flex mt-4">
              <button
                type="button"
                className="inline-flex items-center px-4 py-2 text-lg font-medium prose text-white bg-indigo-600 border border-transparent rounded-sm shadow-xs hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
              ...
              {features.map((feature) => (
                ...
                >
                  ...
                  <dd className="mt-4 text-sm text-gray-500">
                    <button
                      type="button"
                      className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-sm shadow-xs hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    >
