...
export default function HeroLeft({ brand, data }: any) {
  return (
    <>
      {data && (
        <div className="relative overflow-hidden">
          <main className="flex flex-wrap w-full md:h-screen">
            <div className="w-full pt-6 md:pt-0 md:flex-1 md:order-first">
            ...
            <div className="relative flex items-center justify-center w-full p-6 pb-12 md:p-12 md:w-5/12">
              <div className="relative w-full px-12 py-12 text-center md:p-0 md:text-left">
