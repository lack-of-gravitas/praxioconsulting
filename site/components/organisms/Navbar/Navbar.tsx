                    ...
                    {false && (
                      <div className="flex-shrink-0">
                        <button
                          ...
                          className="relative inline-flex items-center px-4 py-2 text-sm font-medium text-white border border-transparent shadow-xs rounded-xs hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        >
                          <PlusIcon
                    ...
                    {false && (
                      <div className="hidden md:ml-4 md:flex-shrink-0 md:flex md:items-center">
                        <Menu as="div" className="relative ml-3">
                          ...
                          >
                            <Menu.Items className="absolute right-0 w-48 py-1 mt-2 origin-top-right bg-white shadow-xs rounded-xs ring-1 ring-black ring-opacity-5 focus:outline-none">
                              <Menu.Item>
                                {({ active }: any) => (
                                  <a
                                    href="#"
