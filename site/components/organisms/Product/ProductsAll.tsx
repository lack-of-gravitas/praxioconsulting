                ...
                {product.slug && (
                  <div className="flex items-center justify-end px-4 py-2 bg-white">
                    ...
                    >
                      <button
                        type="button"
                        className="relative inline-flex items-center px-4 text-lg font-medium text-white border border-transparent rounded-xs shadow-lg hover:text-white bg-indigo-700 hover:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primaryColor-800"
                      >
                        <ArrowRightIcon
                          className="w-6 h-6 mr-2 -ml-1"
                          aria-hidden="true"
                        />
                        <span className="p-3 px-5 text-white rounded-xs cursor-pointer ">
                          Learn More
                        </span>
                      </button>
                    </Link>
